<template>
  <div class="flex flex-col h-screen justify-between">
    ...
    >
      ...
      <div class="my-4 mx-auto font-dlot-logo text-center text-xs leading-4 text-gray-700 absolute inset-x-0 bottom-0">
        <copyright class="flex flex-col justify-center mx-2">
          <template>
